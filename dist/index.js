    ...
    init() {
        ...
        document.addEventListener('click', (e) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (target && target.dataset && target.dataset.type === 'ActivateScene' && target.dataset.broken === 'false') {
                e.preventDefault();
                yield activateScene(target.dataset.id);
            }
        }));
...
function showTemporaryJournalEntry(options) {
    var _a;
    return __awaiter(this, void 0, void 0, function* () {
        const entry = yield JournalEntry.create({
            name: options.name,
            pages: [
                {
                    name: options.name,
        ...
        yield ((_a = entry.sheet) === null || _a === void 0 ? void 0 : _a.render(true));
    });
}
...
class OgSetting {
    ...
    ready() {
        ...
        game.settings.register(namespace, this.key, Object.assign({
            scope: 'client',
            config: true,
...
class SocialEncounterTrackerForm extends FormApplication {
    ...
    activateListeners(html) {
        html.find('button').on('click', function () {
            var _a;
            (_a = game.socket) === null || _a === void 0 ? void 0 : _a.emit('module.og-experiments', { whatver: true });
        });
...
function registerGameExtensions(key, setting) {
    ...
    game[gameExtensionsKey][key] = Object.assign(Object.assign({}, game[gameExtensionsKey][key]), setting);
}
...
/* harmony import */ var _src_server_push__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./src/server-push */ "./src/server-push.ts");
...
const modules = [
    ...
    new _src_server_push__WEBPACK_IMPORTED_MODULE_1__.ServerPush(),
